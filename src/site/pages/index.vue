		...
		<div class="leftSpacer">
			<div class="mainBlock">
				<div>
					<h1>Hi there</h1>
					<p>
						It's a Chibisafe self-hosted service hosted by Aru Moon. Read <nuxt-link :to="`/rules`">Rules</nuxt-link> first.<br>I purge all files when the server's disk is full (I don't have much space).<br>Use it only as a temporary storage :)<br>
					</p>
					<p>
